...
const wrapErrorWithStack_1 = require("./wrapErrorWithStack");
...
function init(options) {
    ...
    if (options.forceEnable || Meteor.isProduction) {
        ...
        if (!options.enrichConsoleErrors) {
            ...
            sentryOptions.integrations.push(Sentry.captureConsoleIntegration({
                levels: ["error"]
            }));
        }
        if (options.integrations) {
            sentryOptions.integrations.push(...options.integrations);
        }
        ...
        if (options.enrichConsoleErrors) {
            ...
            sentryOptions.integrations.push((0, wrapErrorWithStack_1.wrapErrorWithStackIntegration)());
        }
        //
        // Init Sentry
